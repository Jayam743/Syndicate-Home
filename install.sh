...
echo "  ✓ ~/.syndicate/loki/ (live improvement findings — auto-logged by /retro; LOCAL ONLY, never committed)"
echo "  ✓ loki/CHANGELOG.md is LOCAL-only too (gitignored, regenerable via scripts/loki-changelog.sh) — no Loki content is committed"
